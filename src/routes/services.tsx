  ...
  head: () => ({
    meta: [
      { title: "Kayoze" },
      {
        name: "description",
        content:
          "Bespoke suits, woolen jackets, traditional Bandi coats, custom shirts, overcoats and formalwear — handcrafted by Kayoze.",
      },
      { property: "og:title", content: "Bespoke Services — Kayoze" },
      {
        property: "og:description",
        content:
          "Our full range of bespoke menswear services, from business suits to traditional Bandi coats.",
      },
    ],
  }),
  ...
  return (
    <Layout>
      ...
      <section className="px-6 pb-32">
            ...
            <FadeIn key={s.t}>
              ...
              >
                ...
                <div>
                  ...
                  <Link to="/book" className="btn-outline-gold mt-10">
                    Begin Commission
                  </Link>
                </div>
              </article>
        ...
        {/* CTA */}
        <FadeIn>
          <div className="mt-32 max-w-5xl mx-auto border border-border p-12 lg:p-20 text-center relative overflow-hidden">
            ...
            <h2 className="mt-6 text-4xl md:text-6xl font-display leading-tight">
              Craft your <em className="gold-text not-italic">legacy</em> garment.
            </h2>
            <p className="mt-6 text-muted-foreground max-w-xl mx-auto">
              Whether for a wedding, business or heritage occasion — your journey starts with a
